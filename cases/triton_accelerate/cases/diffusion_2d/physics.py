"""2D Pure Diffusion (heat equation on periodic domain).

PDE: c_t = nu*(c_xx + c_yy), nu=0.01.
Exact: C = sin(x)*sin(y)*exp(-2*nu*t). Perfectly smooth.
"""
...
# ─── Constants ───────────────────────────────────────────────────────────────
CASE_NAME = "diffusion_2d"
nu = 0.01
u0 = 0.0   # no advection, pure diffusion
v0 = 0.0   # no advection, pure diffusion
Nx, Ny, Nt = 64, 64, 20
GRID_SHAPE = (Nt, Nx, Ny)
MLP_THRESHOLD = 1e-4
CNN_THRESHOLD = 1e-4
