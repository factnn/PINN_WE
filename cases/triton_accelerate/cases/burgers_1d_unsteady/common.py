"""Shared utilities for 1D Burgers experiments."""
...
def exact_burgers(x_np, t_np):
    ...
    def rhs(t, u_int):
        ...
        u_x = (u[2:]-u[:-2])/(2*dx)
        return -u_int*u_x + (0.01/np.pi)*D2@u_int
...
def train_and_save(backend_name, loss_fn, model_fn=None,
    ...
    # bytes per step: U field [Nt,Nx] float32, stencil ~5 reads + 1 write
