...
Guderley 漏斗扫描实验 V2 (使用修正后的二阶ODE方程)
...
class AlphaScanExperiment:
    ...
    def train_fixed_alpha(
        ...
        for epoch in range(1, adam_epochs + 1):
            ...
            # 修正：使用新的函数签名（添加xi_center和mach_inf）
    ...
    def run_scan(self):
        ...
        print("=" * 60)
        print("Guderley 漏斗扫描实验 V2（使用修正后的二阶ODE）")
        print("=" * 60)
    ...
    def plot_results(self):
        ...
        ax1.set_title('Loss vs α (线性尺度) - 修正后二阶ODE', fontsize=14)
        ax1.legend()
        ...
        ax2.set_title('Loss vs α (对数尺度) - 修正后二阶ODE', fontsize=14)
        ax2.legend()
        ax2.grid(True, alpha=0.3)

        plt.tight_layout()

        plot_file = self.output_dir / "funnel_plot_v2.png"
