import sys
import os
# 添加PINNsrc路径 - 从cases/1D/Blast到PINNsrc需要向上三级
pinn_src_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../PINNsrc'))
sys.path.insert(0, pinn_src_path)
print(f'添加路径: {pinn_src_path}')
